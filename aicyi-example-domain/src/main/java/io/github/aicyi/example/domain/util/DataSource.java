...
import io.github.aicyi.example.domain.mapper.StudentBeanMapper;
...
public class DataSource {
    ...
    public static StudentBean getStudent() {
        StudentBean student = StudentBeanMapper.INSTANCE.toStudentBean(getUser());
...
//    }
    ...
    public static ExampleBean getExample() {
        ...
        StudentBeanMapper.INSTANCE.updateStudentBean(user, student);
